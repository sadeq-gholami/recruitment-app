...
class Applicant extends RequestHandler {
    ...
    async appHandler() {
        ...
        /**
         * Add competence to competence profile
         */
        ...
        /**
         * Add application status, connected to user
         */
        ...
        /**
         * Add availability, connected to user
         */
        ...
        /**
         * Uppdate ready status of a users application
         */
